...
static const char *TAG = "remote_encoder";
...
static size_t remote_encoder_encode(rmt_encoder_t *encoder, rmt_channel_handle_t channel, const void *primary_data, size_t data_size, rmt_encode_state_t *ret_state)
{
    remote_encoder_t *nec_encoder = __containerof(encoder, remote_encoder_t, base);
    rmt_encode_state_t session_state = RMT_ENCODING_RESET;
    rmt_encode_state_t state = RMT_ENCODING_RESET;
    size_t encoded_symbols = 0;
    remote_scan_code_t *scan_code = (remote_scan_code_t *)primary_data;
...
static esp_err_t remote_encoder_delete(rmt_encoder_t *encoder)
{
    remote_encoder_t *nec_encoder = __containerof(encoder, remote_encoder_t, base);
...
static esp_err_t remote_encoder_reset(rmt_encoder_t *encoder)
{
    remote_encoder_t *nec_encoder = __containerof(encoder, remote_encoder_t, base);
...
esp_err_t remote_encoder_new(const remote_encoder_config_t *config, rmt_encoder_handle_t *ret_encoder)
{
    ...
    remote_encoder_t *nec_encoder = NULL;
    ESP_GOTO_ON_FALSE(config && ret_encoder, ESP_ERR_INVALID_ARG, err, TAG, "invalid argument");
    nec_encoder = rmt_alloc_encoder_mem(sizeof(remote_encoder_t));
    ESP_GOTO_ON_FALSE(nec_encoder, ESP_ERR_NO_MEM, err, TAG, "no mem for ir nec encoder");
    nec_encoder->base.encode = remote_encoder_encode;
    nec_encoder->base.del = remote_encoder_delete;
    nec_encoder->base.reset = remote_encoder_reset;
